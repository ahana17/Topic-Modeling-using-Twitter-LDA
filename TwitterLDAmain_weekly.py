...
class TwitterLDAmain:
    ...
    def __init__(self, mon, week, data_dir = "/data"):
        self.base = os.getcwd() + data_dir
        self.name = "test"
        self.mon = mon
        self.week = week
        self.filelist = self.base + "/files/" + self.mon + self.week + "_files.txt"
        self.dataDir = self.base + "/Data4Model/" + self.name + "/"
        self.dataDir = self.base + "/Data4Model/" + self.name + "/"+ self.mon +"/"
        self.outputDir = self.base + "/ModelRes/" + self.name + "/"+ self.mon +"/" + self.week +"/"
